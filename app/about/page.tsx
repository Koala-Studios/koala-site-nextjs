      ...
      <div style={{ backgroundColor: "#181A17", overflowX: "hidden" }}>
        ...
        >
          <p style={{ fontFamily: "Poppins-Regular" }}>
            ...
            high-quality services that align with their values and goals. At
            Koala Studios, we prioritize quality above all else. We understand
            that every brand is unique, and that&apos;s why we take the time to
            get to know our clients and their values.
            <br />
            <br />
            We believe that a website should not only be visually appealing but
            also reflect the brand&apos;s personality and message. That&apos;s
            why we work closely with our clients to create custom solutions that
